...
![Binary classification of wine quality scores, where 0 to 5 is 'bad' and 6 to 9 is 'good'.](/images//project/machineLearning/supervised/wine-label-distribution.jpg)
...
![Simple view of KNN classification](/images//project/machineLearning/supervised/knn.png)
...
![Train and Test scores vs K — with an optimal k at about 25](/images//project/machineLearning/supervised/wine-knn.png)
...
![Pruning can reduce overfitting](/images//project/machineLearning/supervised/dt-pruning.jpg)
...
![An ANN typically consists of an input layer, any number of hidden layers, and an output layer](/images//project/machineLearning/supervised/ann.png)
...
![Wine converging at about 340 training examples, while abalone takes about 1000](/images//project/machineLearning/supervised/ann-learning-curve.jpg)
...
![A parallel vs sequential method of ensemble learning](/images//project/machineLearning/supervised/boostingbagging.jpg)
...
![A clear max score around 35 estimators and a learning rate of 0.04](/images//project/machineLearning/supervised/boostingLearningRate.jpg)
...
![Support vectors and the maximum margin](/images//project/machineLearning/supervised/svm.jpg)
...
![Another example of bias-variance tradeoff — max scores around a `gamma` of 3 and a `C` of 10](/images//project/machineLearning/supervised/gamma-c-scores-svm.jpg)
...
![Boosting takes the cake!](/images//project/machineLearning/supervised/supervised-test-perf.jpg)
